...
import com.eroglu.newsapp.NewsApplication
        ...
        if(response.isSuccessful) {
            response.body()?.let { resultResponse ->
                ...
                if(breakingNewsResponse == null) {
                    ...
                    breakingNewsResponse?.articles?.let {oldArticles ->
                        response.body()?.articles?.let { newArticles->
                            oldArticles.addAll(newArticles)
                            newArticles.clear()
                            newArticles.addAll(oldArticles)
                        }
                    }
